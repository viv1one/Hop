...
description: Guides creation of professional, polished mobile app interfaces — typography, 8-point spacing grid, 60/30/10 color system, shadows, and peak-end emotional design — following patterns used by top-tier apps like Airbnb, Duolingo, Spotify, Revolut, and Phantom. Load when designing or reviewing mobile UI/UX screens, choosing colors/spacing/typography for an app, or building React/HTML mockups of app screens.
---
...
- What industry design conventions apply? (See [references/industry-conventions.md](references/industry-conventions.md))
...
For deeper guidance on industry-specific conventions and emotional design patterns, read [references/industry-conventions.md](references/industry-conventions.md).
